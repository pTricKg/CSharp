    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime, MouseState mouse)
        {
            ...
            if (collecting)
            {
                ...
                drawRectangle = new Rectangle((int)location.X - halfDrawRectangleWidth / 2, 
                    (int)location.Y - halfDrawRectangleHeight / 2, sprite.Width, sprite.Height);
            }
        ...
        public void SetTarget(Vector2 target)
        {
            ...
            // set magnitude
            target.Normalize();
            velocity.X = target.X * BaseSpeed;
            velocity.Y = target.Y * BaseSpeed;
